# This migration ports everything from Exercism version 2.
# It will not be run if the active_storage_attachements table exists
# which is the case for the existing v2 database. The next migration
# is an ETL migration that mutates the database to prepare it for v3.

class MigrateV2 < ActiveRecord::Migration[6.0]
  def up
